...
Modified principles:
  - All five principles newly populated from existing docs (no prior named principles)
...
Removed sections:
  - None (first fill of template)

Templates reviewed and status:
  - .specify/templates/plan-template.md    ✅ aligned (Constitution Check section present)
  - .specify/templates/spec-template.md    ✅ aligned (FR-xxx MUST language matches principles)
  - .specify/templates/tasks-template.md   ✅ aligned (test-optional note matches Principle II)
  - .specify/templates/commands/           ✅ N/A (no command files found)
...
1. **Feature branches**: All work MUST occur on a branch named
   `feature/<short-description>` branched from `main`.
